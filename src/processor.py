...
if col_qty and col_pu and col_pt:
    ...
    for r in range(2, ws_bc.max_row + 1):
        ws_bc.cell(row=r, column=col_pt).value = f'=IF(OR({qty_letter}{r}="",{pu_letter}{r}=""),"",{qty_letter}{r}*{pu_letter}{r})'
...
if col_qty and col_wu and col_wt:
    ...
    for r in range(2, ws_bc.max_row + 1):
        ws_bc.cell(row=r, column=col_wt).value = f'=IF(OR({qty_letter}{r}="",{wu_letter}{r}=""),"",{qty_letter}{r}*{wu_letter}{r})'
